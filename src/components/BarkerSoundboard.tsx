...
export default function BarkerSoundboard() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
      ...
      <div className="lg:col-span-5 flex flex-col justify-between bg-gradient-to-br from-amber-50 to-orange-100/50 dark:from-slate-900/60 dark:to-indigo-950/25 border border-orange-100 dark:border-indigo-900/40 rounded-3xl p-6 lg:p-8 shadow-sm">
      ...
      <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
        ...
        {/* Piano / Xylophone */}
        <div className="space-y-3 bg-white dark:bg-indigo-950/30 border border-orange-100 dark:border-indigo-900/40 rounded-3xl p-5 lg:p-6 shadow-sm">
